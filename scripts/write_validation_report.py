...
def main():
    ...
    names = ('benchmark_core.py', 'benchmark_cli.py', 'reference_executor.py',
    ...
    invalid = suite.get('invalid_products', [])
    report = {
        'created_utc':datetime.now(timezone.utc).isoformat(),
        'scope':'MuJoCo Oracle baseline, snap connections; no real-robot validation',
        'unit_tests_passed':args.unit_tests,
        'catalogue_products':suite.get('input_products'),
